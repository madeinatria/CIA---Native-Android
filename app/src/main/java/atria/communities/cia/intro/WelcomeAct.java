...
import atria.communities.cia.BasicDetailsActivity;
import atria.communities.cia.BottomNavigationActivity;
import atria.communities.cia.MainActivity;
import atria.communities.cia.R;
import atria.communities.cia.User.UserLocalStore;
import atria.communities.cia.YAY;
...
public class WelcomeAct extends AppCompatActivity {
    ...
    private void launchHomeScreen() {
        ...
        /*startActivity(new Intent(getApplicationContext(),BasicDetailsActivity.class));
        finish();
*/
...
/*
        ...
        if(user ==null){
            ...
            Intent intent2 = new Intent(WelcomeAct.this,YAY.class);
...
//tent intent = new Intent(SplashActivity.this, BottomNavigationActivity.class);
else{
